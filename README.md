...
### Sobre o projeto:
Este projeto foi desenvolvido como parte da disciplina **Banco de Dados I** no IFRJ - Niterói, com o objetivo de aplicar na prática os conceitos de modelagem, criação e manipulação de um banco de dados integrado a uma aplicação web.
